...
class TestDataParser(unittest.TestCase):
	...
	def test_build_network_from_input_files_large_network(self):
		...
		self.assertTrue((nnet.layers[2].input_weights == expected_input_weights_third_layer).all())
